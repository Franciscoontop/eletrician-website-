    ...
    <footer className="footer reveal-footer">
      ...
      <div className="container" style={{ padding: '6rem 2rem 2rem' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '4rem', marginBottom: '4rem' }}>
          ...
          {/* Column 1: Company */}
          <div>
            <div className="nav-logo" style={{ marginBottom: '1.5rem', color: '#fff', fontSize: '2rem' }}>
          ...
          <div>
            <h4 style={{ fontSize: '1.25rem', marginBottom: '1.5rem', color: '#fff', fontWeight: 600 }}>Quick Links</h4>
          ...
          <div>
            <h4 style={{ fontSize: '1.25rem', marginBottom: '1.5rem', color: '#fff', fontWeight: 600 }}>Service Areas</h4>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div>
            <h4 style={{ fontSize: '1.25rem', marginBottom: '1.5rem', color: '#fff', fontWeight: 600 }}>Contact & Hours</h4>
            <div style={{ background: 'rgba(245,158,11,0.05)', border: '1px solid rgba(245,158,11,0.2)', padding: '1.5rem', borderRadius: '16px', marginBottom: '1.5rem' }}>
              ...
              <a href="tel:1-800-HEATH-NJ" style={{ color: '#fff', fontSize: '1.5rem', fontWeight: 700, textDecoration: 'none' }}>1-800-HEATH-NJ</a>
            </div>
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '0.75rem', color: 'var(--text-muted)', fontSize: '0.95rem' }}>
              <li style={{ display: 'flex', justifyContent: 'space-between' }}><span>Mon - Fri:</span> <span style={{ color: '#fff' }}>8:00 AM - 6:00 PM</span></li>
              <li style={{ display: 'flex', justifyContent: 'space-between' }}><span>Saturday:</span> <span style={{ color: '#fff' }}>9:00 AM - 2:00 PM</span></li>
        ...
        <div style={{ textAlign: 'center', paddingTop: '2.5rem', borderTop: '1px solid rgba(255,255,255,0.05)', color: 'var(--text-muted)', fontSize: '0.9rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          <span style={{ color: '#fff', fontWeight: 600 }}>NJ Electrical Contractor License #NJ12345 | Fully Insured & Bonded</span>
